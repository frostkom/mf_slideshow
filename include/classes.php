...
class mf_slideshow
{
	...
	function settings_slideshow()
	{
		...
		$arr_settings['setting_slideshow_display_text_background'] = __("Display Text Background", $this->lang_key);
		...
		{
			$arr_settings['setting_slideshow_animate'] = __("Animate", $this->lang_key);
